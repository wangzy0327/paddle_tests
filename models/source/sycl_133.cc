...
void fn_reshape_0_reshape_1_reshape_2_reshape_3_broadcast_to_5_scale_7_fill_constant_10_pow_11_subtract_6_broadcast_to_12_elementwise_mul_13_broadcast_to_14_broadcast_to_16_elementwise_mul_15_elementwise_add_17_fill_constant_18_max_19_21_kernel(sycl::queue &Q, sycl::range<3> dimGrid, sycl::range<3> dimBlock, void** void_args) {
  ...
  Q.submit([&](sycl::handler &h) {
    h.parallel_for<class space133_fn_reshape_0_reshape_1_reshape_2_reshape_3_broadcast_to_5_scale_7_fill_constant_10_pow_11_subtract_6_broadcast_to_12_elementwise_mul_13_broadcast_to_14_broadcast_to_16_elementwise_mul_15_elementwise_add_17_fill_constant_18_max_19_21_kernel>(sycl::nd_range<3>(dimGrid * dimBlock, dimBlock), [=](sycl::nd_item<3> item) [[intel::kernel_args_restrict]][[intel::max_work_group_size(1, 1, 1)]]
    {
      for (int32_t flat_i = 0; flat_i < 1228800; flat_i += 1) {
        var_53[flat_i] = sycl::max(((batch_norm2d_0__w_0[(flat_i / 19200)] * (cinn_sycl_rsqrt_fp32((batch_norm2d_0__w_2[((flat_i % 1228800) / 19200)] + 9.99999975e-06f)) * conv2d_0__tmp_0[flat_i])) + ((-1.00000000f * (batch_norm2d_0__w_0[(flat_i / 19200)] * (cinn_sycl_rsqrt_fp32((batch_norm2d_0__w_2[((flat_i % 1228800) / 19200)] + 9.99999975e-06f)) * batch_norm2d_0__w_1[(flat_i / 19200)]))) + batch_norm2d_0__b_0[(flat_i / 19200)])), 0.00000000f);
      };
    });
  });
}
