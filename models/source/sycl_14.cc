...
void fn_fill_constant_8_fill_constant_4_pow_9_17_kernel(sycl::queue &Q, sycl::range<3> dimGrid, sycl::range<3> dimBlock, void** void_args) {
  ...
  Q.submit([&](sycl::handler &h) {
    h.parallel_for<class space14_fn_fill_constant_8_fill_constant_4_pow_9_17_kernel>(sycl::nd_range<3>(dimGrid * dimBlock, dimBlock), [=](sycl::nd_item<3> item) [[intel::kernel_args_restrict]][[intel::max_work_group_size(1, 1, 1)]]
    {
